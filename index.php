...
<head>
    ...
    <meta name="description" content="An awesome single page portfolio website. you can easily design your website by me.">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title> Cuda - an awesome single page portfolio tamplate</title>
    <link rel="shortcut icon" type="image/x-icon" href="resourses/images/favicon.png">
    <!-- GOOGLE FONTS -->
    <link href="https://fonts.googleapis.com/css?family=Titillium+Web:300,400,600,700&display=swap" rel="stylesheet">
    <!-- FONT AWESOME -->
    <link rel="stylesheet" type="text/css" href="resourses/css/all.min.css">
    <!-- VENDORS FILES -->
    <link rel="stylesheet" type="text/css" href="vendors/css/normalize.css">
    <link rel="stylesheet" type="text/css" href="vendors/css/grid.css">
    <!-- RESOURSES FILES -->
    <link rel="stylesheet" type="text/css" href="resourses/css/style.css">
    <link rel="stylesheet" type="text/css" href="resourses/css/responsive.css">
</head>
...
<body>
    ...
    <header id="home">
        <nav>
            <div class="row">
                <a href="#home">
                    <img class="logo" src="resourses/images/logo.png" alt="Logo">
                </a>
                <ul class="main-nav">
    ...
    <section class="services-section js--services-section" id="service">
        ...
        <div class="row">
            <div class="col span_1_of_4 box">
                <img src="resourses/images/flag.png" alt="Flag" class="services-icon">
                <h3>Branding</h3>
                <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh.</p>
            </div>
            <div class="col span_1_of_4 box">
                <img src="resourses/images/crayon.png" alt="Crayon" class="services-icon">
                <h3>Design</h3>
                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem Sed ut perspiciatis</p>
            </div>
            <div class="col span_1_of_4 box">
                <img src="resourses/images/gears.png" alt="Gears" class="services-icon">
                <h3>Development</h3>
                <p>At vero eos et accusamus et iusto odio dignissimos qui blanditiis praesentium.</p>
            </div>
            <div class="col span_1_of_4 box">
                <img src="resourses/images/rocket.png" alt="Rocket" class="services-icon">
    ...
    <section class="team-section" id="team">
        <div class="row">
            ...
            <p class="little-description">We are a small team of designers and developers, who help brands with big deas.</p>
        </div>
        <div class="row">
            <div class="col span_1_of_4 box">
                <img src="resourses/images/1.jpg" alt="ANNE HATHAWAY" class="team-member">
                <h3>ANNE HATHAWAY</h3>
            ...
            <div class="col span_1_of_4 box">
                <img src="resourses/images/2.jpg" alt="Kate Upton" class="team-member">
                <h3>Kate Upton</h3>
            ...
            <div class="col span_1_of_4 box">
                <img src="resourses/images/3.jpg" alt="Olivia Wilde" class="team-member">
                <h3>Olivia Wilde</h3>
            ...
            <div class="col span_1_of_4 box">
                <img src="resourses/images/4.jpg" alt="Ashley Greene" class="team-member">
                <h3>Ashley Greene</h3>
    ...
    <section class="portfolio-section" id="portfolio">
        ...
        <div class="row container">
            <div class="col span_1_of_2 mix apps box">
                <img src="resourses/images/portfolio1.png" alt="Isometric Perspective Mock-Up" class="portfolio-image">
                <h4>Isometric Perspective Mock-Up</h4>
            </div>

            <div class="col span_1_of_2 mix apps web box">
                <img src="resourses/images/portfolio2.png" alt="Time Zone App UI" class="portfolio-image">
                <h4>Time Zone App UI</h4>
            </div>

            <div class="col span_1_of_2 mix icons box">
                <img src="resourses/images/portfolio3.png" alt="Viro Media Players UI" class="portfolio-image">
                <h4>Viro Media Players UI</h4>
            </div>

            <div class="col span_1_of_2 mix icons web apps box">
                <img src="resourses/images/portfolio4.png" alt="Blog / Magazine Flat UI Kit" class="portfolio-image">
                <h4>Blog / Magazine Flat UI Kit</h4>
            </div>
        </div>
        <div class="row">
            <a class="btn btn-load-more" href="#">LOAD MORE PROJECTS</a>
        </div>
    </section>
    ...
    <section class="testimonial" id="testimonial">
        ...
        <div class="row">
            <div class="col span_1_of_2 box">
                <div class="client-photo">
                    <img src="resourses/images/1.jpg" alt="Chanel Iman">
                </div>
            ...
            <div class="col span_1_of_2 box">
                <div class="client-photo">
                    <img src="resourses/images/2.jpg" alt="ADRIANA LIMA">
                </div>
                <div class="client-review">
        ...
        <div class="row">
            <div class="col span_1_of_2 box">
                <div class="client-photo">
                    <img src="resourses/images/3.jpg" alt="ANNE HATHAWAY">
                </div>
                <div class="client-review">
                    <p>“Vivamus luctus urna sed urna ultricies ac tempor dui sagittis. In condimentum facilisis porta.”</p>
                    <h3>ANNE HATHAWAY</h3>
            ...
            <div class="col span_1_of_2 box">
                <div class="client-photo">
                    <img src="resourses/images/4.jpg" alt="EMMA STONE">
                </div>
                <div class="client-review">
    ...
    <section class="contact" id="contact">
        ...
        <div class="row">
            <form action="https://formspree.io/abdulkayum97bd@gmail.com" method="post">
                <div class="row">
    ...
    <script src="resourses/js/all.min.js"></script>
